    ...
    <div className="w-full max-w-7xl mx-auto flex flex-col gap-16">
      ...
      <section className="w-full flex flex-col gap-6">
        ...
        <div className="w-full flex items-center gap-4">
          ...
          <div className="rounded-3xl overflow-hidden w-[480px] h-[220px] flex-shrink-0 shadow-lg">
            <Image
              src="/banner-demo.jpg"
              alt="banner"
              width={480}
          ...
          <div className="flex flex-col justify-center items-start ml-8">
            ...
            <p className="text-gray-600 text-sm mb-4">为决策层和分门别类的群体提供系统与前沿方案，助力学科升级、实验室升级。</p>
            <button className="bg-[#18506A] text-white px-6 py-2 rounded font-semibold text-sm">了解更多</button>
          </div>
          <button className="text-3xl text-gray-400 hover:text-primary">{'>'}</button>
        </div>
        {/* 面包屑 */}
        <div className="flex gap-3 mt-4 justify-center">
          {breadcrumbs.map((item, idx) => (
            <span
              key={item}
              className="px-4 py-1 rounded-full bg-gray-100 text-gray-700 text-sm font-medium"
            >
              {item}
            </span>
          ))}
      ...
      {/* 中上：服务卡片 */}
      <section className="w-full flex flex-col gap-6">
        <h1 className="text-3xl font-bold font-[family-name:var(--font-han-sans)] mb-4">探索我们的服务</h1>
        <div className="w-full bg-[#18506A] rounded-lg p-8 flex flex-col md:flex-row gap-6">
          {services.map((s, idx) => (
            <div
              key={s.title}
              className={`flex-1 bg-white/10 rounded-lg flex flex-col items-center justify-between p-4 min-h-[220px] ${
            ...
            >
              ...
              <div className="w-full">
                ...
                <button className="bg-white text-[#18506A] px-4 py-1 rounded font-semibold text-sm shadow hover:bg-gray-200">
                  {s.btn}
                </button>
              </div>
            </div>
      ...
      <section className="w-full flex flex-col md:flex-row items-center gap-8">
        ...
        <div className="flex-1 flex justify-center">
          <div className="rounded-3xl overflow-hidden w-[340px] h-[180px] shadow">
            <Image
              src="/about-ceak.jpg"
              alt="关于CEAK"
              width={340}
      ...
      <section className="w-full flex flex-col md:flex-row items-center gap-8">
        ...
        <div className="flex-1 flex flex-col justify-between h-full">
          ...
          <div className="flex justify-end">
            <button className="bg-[#18506A] text-white px-6 py-2 rounded font-semibold text-sm shadow hover:bg-[#133d50]">
              申请职业机会
            </button>
          </div>
        </div>
