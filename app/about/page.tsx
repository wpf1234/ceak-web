  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <section className="mx-auto ml-0 md:ml-10 px-6 md:px-40 pt-14 md:pt-40 flex flex-col gap-6">
        ...
        <p 
        className="text-xl md:text-3xl md:md:text-5xl text-tc 
        leading-loose items-start font-[family-name:var(--font-sans-light)]"
        >
          ...
          {siteConfig.values.map((item, index) => (
            ...
            >
              ...
              <div className="flex-1 flex flex-col items-center md:items-start text-center md:text-left">
                ...
                <p className="text-xl md:text-3xl md:md:text-5xl text-tc font-[family-name:var(--font-sans-light)] leading-loose">
                  {item.desc}
                </p>
              </div>
            </div>
