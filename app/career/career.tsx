    ...
    <div className="w-full flex flex-col">
      ...
      <section className="relative bg-gray-100 py-20 px-4 clip-trapezoid">
        ...
        <div className="text-center max-w-5xl mx-auto mb-12">
          ...
          <p className="text-md md:text-xl text-tc leading-relaxed
          md:leading-loose font-[family-name:var(--font-sans-light)]">
          ...
          {siteConfig.skills.slice(0, 5).map((skill, idx) => (
            ...
            >
              ...
              >
                ...
                <p className="text-xl md:text-2xl text-tc leading-relaxed
                  md:leading-relaxed font-[family-name:var(--font-sans-light)]">
                  {skill.description}
                </p>
              </div>
            </div>
